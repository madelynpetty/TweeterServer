...
public interface FollowDAOInterface {
    ...
    boolean follow(String userAlias, String currUserAlias);

    boolean unfollow(String userAlias, String currUserAlias);

    int getFollowerCount(User follower);

    int getFollowingCount(User followee);

    boolean isFollower(String followeeAlias, String currUserAlias);

    List<User> getFollowees(String userAlias, String lastFolloweeAlias, int limit);

    List<User> getFollowingList(String userAlias);

    List<String> getFollowingAliasList(String userAlias);
